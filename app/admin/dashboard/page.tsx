      ...
      <div className="flex-1">
        <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b bg-background px-4 md:px-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold">TechB Admin</h1>
          </div>
          <div className="flex items-center gap-4">
            <DropdownMenu>
                ...
                <DropdownMenuItem>
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">A new blog post has been published.</p>
                    </div>
                  </div>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">A new user has registered on the blog.</p>
                    </div>
                  </div>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">A new comment has been posted on a blog post.</p>
                    </div>
                  </div>
                </DropdownMenuItem>
              </DropdownMenuContent>
          ...
          <div className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>View, create, edit, and delete blog posts.</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
